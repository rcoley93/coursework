...
extern rgbcolor borderLineColor;
...
class shape {
   ...
   public:
      bool border = false;
      virtual ~shape() {}
      virtual void draw (const vertex&, const rgbcolor&, int i) 
                                                              const = 0;
      virtual void show (ostream&) const;
      virtual void enableBorder();
      virtual void disableBorder();
};
...
//
// Classes triangle right_triangle isosceles equilateral
//

class triangle : public polygon {
   public:
      triangle (const GLfloat x0, const GLfloat y0, const GLfloat x1,
                const GLfloat y1, const GLfloat x2, const GLfloat y2);
};
